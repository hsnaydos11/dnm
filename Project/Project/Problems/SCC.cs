...
namespace Project.Problems
{
    ...
    public class Graph7
    {
        ...
        public void GetStronglyConnectedComponents(int vertex, ref int currentTime, bool[] processed, int[] minConnectedValue, bool[] sccCompleted)
        {
